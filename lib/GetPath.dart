...
import 'package:path_provider/path_provider.dart';
  ...
  class GetPathActivity extends StatelessWidget {
    @override
      ...
      return MaterialApp(
        ...
        home: GetPathfragment(title: 'Path Provider'),
      );
    }
  }

  class GetPathfragment extends StatefulWidget {
    GetPathfragment({Key key, this.title}) : super(key: key);
    final String title;

    @override
    _GetPathfragment createState() => _GetPathfragment();
  }

  class _GetPathfragment extends State<GetPathfragment> {
    ...
    //Functionality only available on iOS/macOS
